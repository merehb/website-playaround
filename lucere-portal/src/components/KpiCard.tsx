...
export function KpiCard({ label, value, hint, sparklineValues }: KpiCardProps) {
  return (
    <div className="card p-5 min-h-[140px] hover:shadow-[0_0_0_3px_var(--ring)] transition-shadow">
      ...
      {sparklineValues ? <div className="mt-3 opacity-80"><Sparkline values={sparklineValues} /></div> : null}
    </div>
  );
}
